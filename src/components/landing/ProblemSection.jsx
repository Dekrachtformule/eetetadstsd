...
function PainCard({ point, index }) {
  ...
  return (
    ...
    >
      <div className="flex gap-6 md:gap-8 items-start h-full p-6 md:p-8 rounded-2xl border border-border/50 bg-card/50 hover:border-primary/40 hover:bg-card/80 transition-all duration-500">
