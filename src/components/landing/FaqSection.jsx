          ...
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border border-border/50 rounded-xl px-6 md:px-8 bg-card/30 backdrop-blur-sm data-[state=open]:border-primary/30 transition-colors duration-300"
              >
