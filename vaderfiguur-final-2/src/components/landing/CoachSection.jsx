...
export default function CoachSection() {
  ...
  return (
    <section ref={ref} className="relative py-20 md:py-28 bg-background overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-1/2 pointer-events-none" style={{background: "radial-gradient(40% 60% at 20% 20%, hsl(var(--primary)/0.06), transparent 70%)"}} />
