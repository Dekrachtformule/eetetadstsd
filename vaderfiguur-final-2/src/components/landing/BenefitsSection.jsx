...
function BenefitCard({ benefit, index }) {
  ...
  return (
    ...
    >
      <div className="relative h-full p-8 md:p-10 rounded-2xl border border-border/50 bg-card/30 overflow-hidden hover:border-primary/40 transition-all duration-500">
